...
<div id="menu-letter">
        ...
        <a href="#" class="let-admin"><p><?=$this->lang->line('letters_admin')?></p></a>
...
<div class="letters-list<?if($row['is_read'] == 0):?>-unread<?endif;?>" id="msg_<?=$row['msg_id']?>">
   <div class="letters-sender">
    <div id="block-letters-foto"><img src="<?=base_url()?>content/img/admin-photo.png"></div>
   </div>
   
    <div class="letters-action"><div id="row"><b><?=$this->lang->line('letters_from')?>:</b> Adminitrator</div>
