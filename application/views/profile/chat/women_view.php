...
<head>
    ...
    <link href="<?php echo base_url(); ?>content/chat/css/chat.css" rel="stylesheet" type="text/css">
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>content/chat/js/video.chat.js"></script>
    ...
    <div class="b-content">
        ...
        <div class="b-messages g-box-style">
            ...
            <div class="b-message-box">
                <a class="b-button-green b-woman-btn" style="display:none;" id="connect" onClick="videochat.connect();">Start
                    video</a>
                <a class="b-button-green b-end-btn" style="display:none;" id="close" onClick="textchat.close();">End
                    chat</a>
                <img src="<?php echo base_url(); ?>content/img/nophoto-mini.png" id="men_img"> <textarea align="left"
                                                                                                         class="text-field"
                                                                                                         id="message"
                ...
                <div id="app">
                    ...
                    <div class="steps">
                        ...
                        <div class="media-buttons">
                            <button class="pure-button pure-button-secondary" @click="changeAudio">{{ audioText }} audio</button>
                            <button class="pure-button pure-button-secondary" @click="changeVideo">{{ videoText }} video</button>
                        </div>
                    </div>
