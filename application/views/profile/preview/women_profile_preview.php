...
<img src="<?=base_url()?>content/img/line.png" style="float:left; margin-top:30px;" width="340" height="8px">
 ...
 <div id="left_column">
        <div id="block-foto"> 
           ...
           <div class="big-foto"><? if($this->userInfo['photo_link'] != ''):?><img src="<?=base_url()?>profiles/photo/user_<?=$this->selfId?>/<?=$this->userInfo['photo_link']?>_342.jpg"><? else: ?><img width="342" height="500" src="<?=base_url()?>content/img/no-foto.png"><? endif; ?></div>
 ...
 <div class="profile-data">
       ...
       <div class="col">            
			...
			<div class="row-odd"><span class="h">English:</span><span class="h-txt"><?=$this->assistant->userEnglish($details['english'])?></span></div>
         </div>
 </div>
      ...
      <div class="profile-info">
       ...
       <div class="profile-info">
		...
		<div class="profile-info">
			...
			<video width="620" height="270">
			<source src="<?=base_url()?>profiles/video/user_<?=$this->selfId?>/<?=$video['video_name']?>" type="<?=$video['mime_type']?>">
			</video>
		</div>
		<? endif; ?>
