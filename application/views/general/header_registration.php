<style>
#header .blok-registration {
	position:relative;
	width:260px;
	float:right;
	padding:15px;
	margin-top:30px;
	border: 3px solid #d67377;
...
#header .btn-enter-reg {
	width: 50%;
	height: 28px;
    border: 1px solid #e5acae;
    color: #333;
    font-weight: bold;
    border-radius: 5px 5px 5px 5px;
    background: linear-gradient(to top, #d67377, #d67377);
    margin-right: 10px;
    cursor: pointer;
    color: #fff;
}

#header .btn-enter-reg:hover {
	background: linear-gradient(to top, #e5acae, #e5acae);
	border: 1px solid #d67377; 
	color:#000000;
}
#header .row2 {
	width:250px;
...
<div class="blok-registration">
 		...
 		<h2 style="margin-top: -10px;"><?=$this->lang->line('r_text')?></h2>
 <div id="clear"></div>  
 <div class="col-reg2">
...
<input type="hidden" name="user_sex" value="1">                      
                     ...
                     <input type="submit" class="btn-enter-reg" value="<?=$this->lang->line('r_button')?>" />
