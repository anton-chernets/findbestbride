                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Разблокировать пользователя</div>
                            </div>
					...
					<input type="hidden" value="1" name="new">
						<fieldset>
  							<div class="control-group">
  								...
  								<div class="controls">
  									<?=$this->aModel->createUserUnbanList();?>
  								</div>
  							</div>
  						
  							<div align="center">
  								<button type="button" onClick="blockUser();" class="btn btn-primary">Разблокировать</button>
