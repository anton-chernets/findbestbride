      <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Отключенные романтические туры</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
       <? if ($tour != false): ?>
                                    ...
                                    <tbody>
 									...
 									?>
                                        <tr id="id_<?=$row['tour_id']?>" <? if($row['status'] == 2):?>class="danger"<?elseif($row['status'] == 0):?>class="warning"<?else:?>class="success"<?endif;?>>
						                	...
						                	<td align="center">
                            				<? if ($row['status'] == 2):?><button type="button" onClick="setActive('<?=$row['tour_id']?>');" title="Активировать" class="btn btn-success btn-circle"><i class="fa fa-check"></i>
                            				</button>
                            				<?endif;?></td>
                                        </tr>
                                    <? endforeach; ?>
